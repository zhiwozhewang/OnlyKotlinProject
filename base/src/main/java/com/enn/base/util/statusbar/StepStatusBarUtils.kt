...
object StepStatusBarUtils {
    ...
    fun setLightStatusBar(
        ...
        when (MyRomUtils.getLightStatausBarAvailableRomType()) {
            MyRomUtils.AvailableRomType.MIUI -> if (MyRomUtils.getMIUIVersionCode() >= 7) {
            ...
            MyRomUtils.AvailableRomType.FLYME -> setFlymeLightStatusBar(
                activity,
                isMarginStatusBar,
                isMarginNavigationBar,
                isTransStatusBar,
            ...
            MyRomUtils.AvailableRomType.ANDROID_NATIVE -> setAndroidNativeLightStatusBar(
                activity,
                isMarginStatusBar,
                isMarginNavigationBar,
                isTransStatusBar,
            ...
            MyRomUtils.AvailableRomType.NA -> {}
        }
    }
    ...
    private fun setFlymeLightStatusBar(
        ...
        if (activity != null) {
            ...
            try {
                ...
                result = true
                if (MyRomUtils.getFlymeVersion() >= 7) {
                    setAndroidNativeLightStatusBar(
                        activity,
                        isMarginStatusBar,
                        isMarginNavigationBar,
